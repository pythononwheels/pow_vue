...
from pow_vue.powlib import get_class_name
from pow_vue.config import myapp
from pow_vue.application import log_handler
import logging
...
import importlib
for m in mods:
    mod = importlib.import_module('pow_vue.models.sql.' + m)
...
#from pow_vue.dblib import Base
