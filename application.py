...
from pow_vue.database.sqldblib import Base, Session, engine
from pow_vue.config import myapp
from pow_vue.config import routes
...
class Application(tornado.web.Application):
    ...
    def import_all_handlers(self):
        ...
        import importlib
        for m in mods:
            #print("importing: " + 'pow_vue.handlers.' + m)    
            try:
                mod = importlib.import_module('pow_vue.handlers.' + m)
            except:
                pass
            #print(dir(mod))
