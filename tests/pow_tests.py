...
class TestClass:
    ...
    def test_server(self):
        ...
        import pow_vue.server
        import requests
        import pow_vue.config as cfg
        import time
        p = Process(target=pow_vue.server.main)
        p.start()
    ...
    def test_sql_generate_model(self):
        ...
        import pow_vue.generate_model as gm
        import uuid
        import os.path
        ret = gm.generate_model(MODELNAME, "sql", appname="pow_vue")
    ...
    def test_sql_model_type(self):
        ...
        from pow_vue.models.sql.pow_test_model import PowTestModel
        m = PowTestModel()
    ...
    def test_sql_dbsetup(self):
        ...
        import pow_vue.init_sqldb_environment
        import os
        os.chdir("..")
        r = pow_vue.init_sqldb_environment.init_migrations()
        assert r == True
    ...
    def test_sql_migration(self):
        ...
        import pow_vue.generate_migration
        import os
        os.chdir("..")
        script = pow_vue.generate_migration.generate_migration(message="pow_test")
    ...
    def test_sql_dbupdate(self):
        ...
        import pow_vue.update_db
        import os, time
        ret = None
        os.chdir("..")
        time.sleep(1)
        try:
            ret = pow_vue.update_db.migrate("up")
    ...
    def test_tinydb_generate_model(self):
        ...
        import uuid
        import os.path
        ret = gm.generate_model(MODELNAME, "tinydb", appname="pow_vue")
        # generate model returns true in case of success
        assert ret is True
    ...
    def test_tinydb_model_type(self):
        ...
        from pow_vue.models.tinydb.pow_test_model import PowTestModel
        m = PowTestModel()
        assert isinstance(m, PowTestModel)
